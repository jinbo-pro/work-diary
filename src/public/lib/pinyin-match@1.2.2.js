!(function (n, a) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(a)
    : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).PinyinMatch = a())
})(this, function () {
  'use strict'
  var n = [],
    a = {},
    i = {}
  function u(n) {
    for (var a = [], i = [], u = 0; n.length >= u; u++) i.push(!0)
    return e(0, n, [], a, i), a
  }
  function e(a, i, u, o, g) {
    if (a !== i.length)
      for (
        var h = function (h) {
            var t = i.substring(a, h + 1),
              r = !1
            if (
              n.some(function (n) {
              ...
              r = !0
            } else -1 !== n.indexOf(t) && g[h + 1] && (u.push(t), (r = !0))
            if (r) {
              var f = o.length
              e(h + 1, i, u, o, g), o.length === f && (g[h + 1] = !1), u.pop()
            }
          },
          t = a;
        i.length > t;
    ...
    return (
      u(n).forEach(function (n) {
        var i = n.split(' '),
          u = i.length - 1
        i[u].indexOf(',')
          ? i[u].split(',').forEach(function (n) {
              i.splice(u, 1, n), a.push(JSON.parse(JSON.stringify(i)))
            })
          : a.push(i)
      }),
      (0 !== a.length && a[0].length === n.length) || a.push(n.split('')),
      (i = (function (n, a, i) {
        return (
          a in n
  ...
  function h(n, u) {
    if (!n || !u) return !1
    ;(n = n.toLowerCase()), (u = u.replace(/\s+/g, '').toLowerCase())
    var e = n.indexOf(u)
    if (-1 !== e) return [e, e + u.length - 1]
    var g = t(n.split(''), [u.split('')], u)
    return (
      g ||
      t(
        (function (n) {
          for (var i = [], u = 0, e = n.length; e > u; u++) {
            var o = n.charAt(u)
            i.push(a[o] || o)
          }
          return i
  ...
  function t(n, a, i) {
    for (var u = 0; n.length > u; u++)
      for (var e = 0; a.length > e; e++) {
        ...
        if (n.length >= h) {
          for (; o.length > s; s++)
            if (0 === s && ' ' === n[u + s + f]) (f += 1), (s -= 1)
            else if (' ' === n[u + s + c]) (c += 1), (s -= 1)
            else if (!g(n[u + s + c], o[s], !n[u + s + 1] || !o[s + 1], t)) {
              r = !1
              break
            }
          if (r) return [u + f, c + u + s - 1]
        }
      }
    return !1
  }
