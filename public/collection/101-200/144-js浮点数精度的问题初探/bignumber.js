export function bigMain(arg, type) {
 ...
 * 加 +
 */
export const add = (...a) => bigMain(a, 'plus')
/**
 * 减 -
 */
export const min = (...a) => bigMain(a, 'minus')
/**
 * 乘 *
 */
export const tim = (...a) => bigMain(a, 'times')
/**
 * 除 /
 */
export const div = (...a) => bigMain(a, 'div')
